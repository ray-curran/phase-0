...
- What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  The only one that I really had trouble passing was step 8, when I needed to add the carson property (which was an 
  object) to the terah object. I got kind of confused about when I needed to use object literal and whether to use 
  an equal sign or a colon. Eventually I realized I didn't need the var keyword and needed to use a colon. I needed 
  the colon and didn't need the keyword because it was a property within the terah object. 

- How difficult was it to add and delete properties outside of the object itself?
  It wasn't so bad. At first I was using the bracket notation, but I eventually started using the dot notation 
  since it's a little cleaner. I also had to look up the delete keyword. 

- What did you learn about manipulating objects in this challenge?
  It's very similar to just changing a variable as long as you know the object/variable names. It'll be
   more interesting when we can have different variable names adding to an object. 
